package com.liangxin.qlmall_portal.commons.aspect;
...
import com.liangxin.qlmall_portal.commons.utils.IPUtil;
...
public class LimitAspect {
    ...
    @Pointcut("@annotation(com.liangxin.qlmall_portal.commons.connotation.Limit)")
    ...
    public Object around(ProceedingJoinPoint point) throws Throwable {
        ...
        if (count != null && count.intValue() <= limitCount) {
            ...
            throw new LimitAccessException("你已错误登录多次，请稍后再试");
        }
    }
    ...
    private String buildLuaScript() {
        return "  local c" +
                ...
                "\n       return c;" +
                "\n    end" +
                "\n      c = redis.call('incr',KEYS[1])" +//当前值上加一
                "\n   if tonumber(c) == 1 then" +
                "\n        redis.call('expire',KEYS[1],ARGV[2])" +//自动删除
                "\n   end" +
                "\n      return c;";
    }
}
